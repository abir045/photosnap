  ...
  return (
    <div>
      <div className="flex flex-col-reverse justify-between bg-black md:flex-row md:h-[600px]">
        {/* text banner */}
        <div className="flex flex-col items-center p-4 xl:w-[40%]  md:w-[70%] h-[419px]">
      ...
      <div className="flex flex-col justify-between bg-white md:flex-row xl:h-[560px]">
        ...
        <div className="flex flex-col   h-[419px]  p-4 items-center w-full md:w-[70%]  lg:w-[40%]">
          <h1 className="text-black text-[32px] leading-[40px] mt-[10%] uppercase font-bold md:text-[40px] md:w-[60%] md:mr-[25%] mr-[30%] p-2 w-[65%]">
            {homeContent.bannerStories.heading}
          </h1>
          <p className="flex text-[15px] leading-[25px] md:text-base md:w-[85%] w-full p-4 text-black opacity-60">
            {homeContent.bannerStories.body}
          </p>
          <div className="flex space-x-5 w-full mt-2 text-xs ml-[10%] md:ml-[20%]">
      ...
      <div className="flex flex-col-reverse justify-between  bg-white md:flex-row  xl:h-[570px]">
        ...
        <div className="flex flex-col  items-center w-full h-[419px] md:w-[70%]  xl:w-[40%]">
          <h1 className="text-black text-[32px] mt-[20%] uppercase font-bold leading-[40px] p-2 w-full md:w-[70%] ml-[15%] md:mr-[30%] ">
            {homeContent.bannerDesign.heading}
          </h1>
          <p className="flex  ml-2 text-[15px] leadding-[25px] p-4 text-black opacity-60 w-[90%] md:w-[80%]  md:mr-[18%]">
      ...
      <div className="flex flex-col relative w-full  md:grid md:grid-rows-2 md:grid-cols-2 xl:grid-cols-4 xl:grid-rows-1">
        {stories.map((item) => (
          <div className="flex flex-col h-[375px] xl:h-[500px]  md:h-[500px] relative ">
            <img
              className="hidden w-full h-full hover:-translate-y-5 md:flex"
              src={item.img}
            />
            <img
            ...
            <div className="flex w-full space-x-[50%] mx-[2%]   absolute ml-[10%] md:ml-[10%] mt-[50%] pt-[30%] md:mb-[5%] md:bottom-[5%] xl:bottom-[7%]">
      ...
      <div className="flex flex-col  mb-[25%] md:flex-col md:my-[5%] md:space-y-12 xl:flex-row xl:space-x-5 items-center text-center xl:mx-[10%] md:mb-[15%]  mx-[5%]">
        {footerBanners.map((item) => {
          return (
            <div className="flex flex-col  xl:my-5  xl:mt-[5%] md:mt-[15%] md:mb-[10%]">
              ...
              <p className="flex text-[15px] leading-[25px] w-[80%]  opacity-60 xl:w-[80%] md:w-[80%] md:mx-auto xl:mx-auto xl:mb-[25%]">
                {item.description}
              </p>
            </div>
          );
