  ...
  return (
    <div>
      ...
      <div className="flex flex-col-reverse justify-between  bg-white md:flex-row  xl:h-[570px]">
        {/* text banner */}
        <div className="flex flex-col  items-center w-full h-[419px] md:w-[70%] md:h-[600px]  xl:w-[40%] ">
      ...
      <div className="flex flex-col  mb-[25%] md:flex-col md:my-[5%] md:space-y-5 xl:flex-row xl:space-x-5 items-center text-center xl:mx-[10%] md:mb-[15%]  mx-[5%]">
        {footerBanners.map((item) => {
          return (
            <div className="flex flex-col  xl:my-5  xl:mt-[5%] md:mt-[10%] md:mb-[10%]">
              ...
              <p className="flex text-[15px]  leading-[25px] w-full px-[5%] md:pb-3  opacity-60 xl:w-[80%] md:w-[80%] md:mx-auto xl:mx-auto xl:mb-[25%]">
                {item.description}
              </p>
            </div>
          );
